...
const [activeNoteId, setActiveNoteId] = useState(null);
  ...
  useEffect(() => {
    const myNotes = async () => {
      try {
        const res = await axios.get(serverlUrl + "/api/notes/getnotes", { withCredentials: true })
...
try {
  const res = await axios.get(serverlUrl + `/api/notes/${noteId}`,{withCredentials:true})
